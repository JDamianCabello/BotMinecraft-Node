...
**NOTAS:**
- Este archivo será utilizado como referencia durante el desarrollo
- Mantener actualizado con la versión de Mineflayer del proyecto (actualmente usando para Minecraft 1.20.1)
- Incluir ejemplos de código cuando sea posible
- Priorizar las APIs más utilizadas en el proyecto actual